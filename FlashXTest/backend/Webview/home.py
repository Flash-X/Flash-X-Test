...
print("<head>")
print("<title>Flash-X A Multiphysics Multidomain Software </title>")
...
print("<a href=\"/site/flashcode/user_support/flash_howtos/home.py?submit=flashTest-HOWTO.txt\">FlashTest HOW-TO</a>")
print("</div>")
...
if numRows > invocationsPerPage:
  ...
  if thisPageNum > 1:
    ...
    print(("<a class=\"everblue\" " +
           "href=\"/site/testsuite/home.py?target_dir=%s&page=%s\" " % (pathToTargetDir, thisPageNum-1) +
  ...
  for i in range(1, lastPageNum + 1):
    if i == thisPageNum:
      ...
      print(("<a class=\"everblue\" " +
             "href=\"/site/testsuite/home.py?target_dir=%s&page=%s\" " % (pathToTargetDir, i) +
